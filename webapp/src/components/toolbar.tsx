	...
	return (
		<ToolbarContainer>
			...
			<NameManagerDialog
				...
				onSave={() => { console.log("update NamedRanges in model => properties.onNamedRangesUpdate");
				}}
				// namedRanges from model will come as object[]
				namedRanges={Array.from([
					{id: '123', name: 'something', scope: "Invoices", range:"Sheet1!A1:H5"},
					{id: '124', name: 'count', scope: "Sheet 1", range:"Sheet1!B4:H8"},
					{id: '125', name: 'total spent', scope: "Sheet 1", range:"Sheet1!C2:C12"}
				])}
			/>
		</ToolbarContainer>
	);
